...
(
	...
	WALLET			MONEY,
	INVITED_CLIENT	INT													REFERENCES CLIENT(ID)
);
...
(
	...
	OWNER_ID		INT													REFERENCES CLIENT
																		ON DELETE SET NULL
																		ON UPDATE CASCADE,
	...
	SHIPMENT_ID		INT						NOT NULL					REFERENCES SHIPMENT
																		ON DELETE NO ACTION
																		ON UPDATE CASCADE
);
...
(
	NATIONAL_ID		bigserial													PRIMARY KEY,
	...
	MNAME			VARCHAR(20)				NOT NULL,
	LNAME			VARCHAR(20)				NOT NULL,
	MGR_ID			INT													REFERENCES EMPLOYEE
																		ON DELETE SET NULL
																		ON UPDATE CASCADE ,
	STATION_ID		INT													REFERENCES STATION
																		ON DELETE SET NULL
...
(
	...
	KICKOFF_STATION_ID		INT				NOT NULL					REFERENCES STATION
																		ON DELETE NO ACTION
																		ON UPDATE CASCADE,
	DISTINATION_STATION_ID  INT											REFERENCES STATION	
																		ON DELETE SET NULL
																		ON UPDATE CASCADE
);
...
(
	RENTAL_ID			bigserial										PRIMARY KEY,
																		...
																		ON DELETE CASCADE
																		ON UPDATE CASCADE,
	CLIENT_ID			bigserial										REFERENCES CLIENT
																		ON DELETE CASCADE
																		ON UPDATE CASCADE,
	BISCOOT_ID			bigserial										REFERENCES BISCOOT
																		ON DELETE CASCADE
																		ON UPDATE CASCADE
);
...
(
	...
	SUPPLIER_ID		    bigserial					NOT NULL			REFERENCES SUPPLIER
																		ON DELETE CASCADE
																		ON UPDATE CASCADE
);
